    ...
    <?php 
        ...
        if ($_SERVER["REQUEST_METHOD"]=="POST" && isset($_POST["changepass"])) {
            ...
            if ($password === $confirmPassword) {
                ...
                echo '<script>alert("Đổi mật khẩu thành công");window.location.href="/ĐACS2_NEW1/admin/page/setting.php";</script>';
            }
        }
        ...
        if (isset($_COOKIE["role"]) && $_COOKIE["role"] === "admin") {
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["addStaff"])) {
                ...
                echo '<script>alert("Thêm nhân viên thành công");window.location.href="/ĐACS2_NEW1/admin/page/setting.php";</script>';
            }
            ...
            if (isset($_GET['delete'])) {
                ...
                if (isset($_GET['confirm']) && $_GET['confirm'] === 'true') {
                    ...
                    echo '<script>alert("Xóa nhân viên thành công");window.location.href="/ĐACS2_NEW1/admin/page/setting.php";</script>';
                }
            }
        }
    ?>  
                    ...
                    <table>
                        ...
                        <?php 
                            foreach ($listAdmin as $row) {
                                ...
                                <td>' .$row["fullname"]. '</td>';
                                if (empty($listAdmin["avt"])) {
                                    echo '<td><img src="/ĐACS2_NEW1/admin/img/avtmacdinh.jpg" alt=""></td>';
                                }
                                else {
                                    $avt = $listAdmin["avt"];
                                    $infoavt = getimagesizefromstring($avt);
        ...
        <form action="setting.php" method="post" enctype="multipart/form-data">
            <div class="box-change">
                ...
                <div class="save-cancel">   
                    ...
                    <a href="/ĐACS2_NEW1/admin/page/setting.php">Hủy bỏ</a>
                </div>
            </div>
        </form>
    </div>
