...
<body>
    ...
    <div id="main">
        ...
        <div id="intro">
            <div class="box-intro">
                <div class="img-intro">
                    <img src="/ĐACS2_NEW1/user/assets/img/Giới thiệu/a1.png" alt="">
                </div>
                <div class="content-intro">
                    <h1>Giới thiệu</h1>
                    <img src="/ĐACS2_NEW1/user/assets/img/Gioithieu.png" alt="">
                    <p>
                    ...
                    <img src="/ĐACS2_NEW1/user/assets/img/Giới thiệu/a2.jpg" alt="">
                    <p>
                    ...
                    <br>
                    <div>
                        <img src="/ĐACS2_NEW1/user/assets/img/Giới thiệu/a3.jpg" alt="">
                        <img src="/ĐACS2_NEW1/user/assets/img/Giới thiệu/a4.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
