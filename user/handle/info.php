...
<head>
    ...
    <link rel="stylesheet" href="/ĐACS2_NEW1/user/assets/css/info.css">
        ...
        if ($_SERVER["REQUEST_METHOD"]="POST" && isset($_POST["add-bill"])) {
            if (isset($_COOKIE["status"]) && $_COOKIE["status"]==0) {
                ...
                if ($typepay==="Thanh toán trực tiếp") {
                    echo '<script>window.location.href="/ĐACS2_NEW1/user/handle/info.php?typepay=' .$typepay. '"</script>';
                } else {
                ...
                <div class="box-avt">
                    <?php 
                        ...
                        if (empty($listUser["avt"])) {
                            echo '<img src="/ĐACS2_NEW1/user/assets/img/avtmacdinh.jpg" alt="">';
                        }
                        else {
                            $avt = $listUser["avt"];
