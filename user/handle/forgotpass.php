...
<head>
    ...
    <link rel="stylesheet" href="/ĐACS2_NEW1/user/assets/css/forgotpass.css">
...
<body>
    <?php
        ...
        session_start();
        require '/CÔNG NGHỆ VÀ LẬP TRÌNH WEB/ĐACS2_NEW1/PHPMailer-master/src/PHPMailer.php';
        require '/CÔNG NGHỆ VÀ LẬP TRÌNH WEB/ĐACS2_NEW1/PHPMailer-master/src/SMTP.php';
        require '/CÔNG NGHỆ VÀ LẬP TRÌNH WEB/ĐACS2_NEW1/PHPMailer-master/src/Exception.php';
        require '/CÔNG NGHỆ VÀ LẬP TRÌNH WEB/ĐACS2_NEW1/PHPMailer-master/src/POP3.php';
