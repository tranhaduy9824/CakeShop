...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function selectUser() {
        ...
        userDivs[i].addEventListener("click", function() {
            ...
            xhr.open("GET", "/ĐACS2_NEW1/user/contact.php", true);
    ...
    function sendMessage() {
        ...
        form.addEventListener('submit', function(event) {
            ...
            var xhr = new XMLHttpRequest();
            xhr.open('POST', '/ĐACS2_NEW1/user/handle/sendMessage.php', true);
    ...
    function getPreviousMessageId(callback) {
        var xhr = new XMLHttpRequest();
        xhr.open("GET", "/ĐACS2_NEW1/user/handle/getLastMessageId.php", true);
        xhr.responseType = "json";
    ...
    function receiveMessages() {
        var xhr = new XMLHttpRequest();
        xhr.open("GET", "/ĐACS2_NEW1/user/handle/getMessage.php", true);
        xhr.responseType = "json";
